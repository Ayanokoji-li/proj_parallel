...
#include "bfs.cuh"
#include "csr.h"
#include "csr_for_pg.cuh"
#include "cu_ef_graph_for_pg.cuh"
...
int main()
{
    ...
    std::string filename = "/home/ayanokouji/code/Cuda/efg/sample_graphs/small/web-Google.mtx";
    CSR_for_pg csr(filename);
}
